...
class SB_services_1 extends StatefulWidget {
  SB_services_1({Key? key}) : super(key: key);

  @override
  _SB_services_1State createState() => _SB_services_1State();
}

class _SB_services_1State extends State<SB_services_1> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebView(
        ...
        initialUrl: 'https://www.gowaterless.in/sb_service1/',
      ),
    );
  }
}
