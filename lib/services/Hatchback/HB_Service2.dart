...
class HB_services_2 extends StatefulWidget {
  HB_services_2({Key? key}) : super(key: key);

  @override
  _HB_services_2State createState() => _HB_services_2State();
}

class _HB_services_2State extends State<HB_services_2> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebView(
        ...
        initialUrl: 'https://www.gowaterless.in/hb_service2/',
      ),
    );
  }
}
