...
class HB_services_1 extends StatefulWidget {
  HB_services_1({Key? key}) : super(key: key);

  @override
  _HB_services_1State createState() => _HB_services_1State();
}

class _HB_services_1State extends State<HB_services_1> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebView(
        ...
        initialUrl: 'https://www.gowaterless.in/hb_service1/',
      ),
    );
  }
}
