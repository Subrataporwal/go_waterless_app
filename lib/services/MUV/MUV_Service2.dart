...
class MUV_services_2 extends StatefulWidget {
  MUV_services_2({Key? key}) : super(key: key);

  @override
  _MUV_services_2State createState() => _MUV_services_2State();
}

class _MUV_services_2State extends State<MUV_services_2> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebView(
        ...
        initialUrl: 'https://www.gowaterless.in/muv_service2/',
      ),
    );
  }
}
