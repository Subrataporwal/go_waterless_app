...
class MUV_services_1 extends StatefulWidget {
  MUV_services_1({Key? key}) : super(key: key);

  @override
  _MUV_services_1State createState() => _MUV_services_1State();
}

class _MUV_services_1State extends State<MUV_services_1> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebView(
        ...
        initialUrl: 'https://www.gowaterless.in/muv_service1/',
      ),
    );
  }
}
