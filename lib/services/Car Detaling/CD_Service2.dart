...
class CD_services_2 extends StatefulWidget {
  CD_services_2({Key? key}) : super(key: key);

  @override
  _CD_services_2State createState() => _CD_services_2State();
}

class _CD_services_2State extends State<CD_services_2> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebView(
        ...
        initialUrl: 'https://www.gowaterless.in/cd_services2/',
      ),
    );
  }
}
