...
class CD_services_3 extends StatefulWidget {
  CD_services_3({Key? key}) : super(key: key);

  @override
  _CD_services_3State createState() => _CD_services_3State();
}

class _CD_services_3State extends State<CD_services_3> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebView(
        ...
        initialUrl: 'https://www.gowaterless.in/cd_service3/',
      ),
    );
  }
}
