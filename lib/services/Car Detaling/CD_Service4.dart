...
class CD_services_4 extends StatefulWidget {
  CD_services_4({Key? key}) : super(key: key);

  @override
  _CD_services_4State createState() => _CD_services_4State();
}

class _CD_services_4State extends State<CD_services_4> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebView(
        ...
        initialUrl: 'https://www.gowaterless.in/cd_service4/',
      ),
    );
  }
}
