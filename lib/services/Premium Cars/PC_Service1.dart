...
class PC_services_1 extends StatefulWidget {
  PC_services_1({Key? key}) : super(key: key);

  @override
  _PC_services_1State createState() => _PC_services_1State();
}

class _PC_services_1State extends State<PC_services_1> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebView(
        ...
        initialUrl: 'https://www.gowaterless.in/pc_service1/',
      ),
    );
  }
}
