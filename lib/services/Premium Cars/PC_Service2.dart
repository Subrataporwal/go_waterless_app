...
class PC_services_2 extends StatefulWidget {
  PC_services_2({Key? key}) : super(key: key);

  @override
  _PC_services_2State createState() => _PC_services_2State();
}

class _PC_services_2State extends State<PC_services_2> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebView(
        ...
        initialUrl: 'https://www.gowaterless.in/pc_service2/',
      ),
    );
  }
}
